                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center sorting_desc">公司</th>
                                <th class="text-center sorting_asc sorting_asc_disabled">产品名称</th>
                                <th class="text-center sorting_desc sorting_desc_disabled">出发城市</th>
                                <th class="text-center sorting">出发时间</th>
